    ...
    <>
      <nav className="m-0">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center justify-center text-gray-600 capitalize mt-4 md:mt-0">
            <Link
              to={"/#main"}
      ...
      <div className="text-[#999] flex flex-col items-center">
        {/* Main Content */}
        <div className="container mx-auto flex flex-col md:flex-row gap-10 md:gap-60 mt-10 px-4">
          {/* Right Panel - Podcast Preview */}
          <div className="flex-1 bg-[#222] p-4 md:p-6 rounded-lg shadow-lg flex flex-col items-center mt-6 md:mt-0">
          ...
          {/* Left Panel - Controls */}
          <div className="px-6 py-8 md:px-10 md:py-32 rounded-lg shadow-md w-full md:w-1/3 text-left shadow-[var(--secondary-color)]">
            ...
            {/* podcast length */}
            <div className="relative inline-block ml-60 ">
